...
Для запуска тестируемого приложения необходимо запустить целевой сервис: `app-ibank-build-for-testers.jar`, командой: java -jar app-ibank-build-for-testers.jar
